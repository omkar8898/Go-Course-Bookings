...
import (
	...
	"github.com/omkar8898/bookings-main/internal/handlers"
)
...
func routes(app *config.AppConfig) http.Handler {
	...
	// mux.Get("/user/registration", handlers.Repo.ShowRegistration)
	// mux.Post("/user/registration", handlers.Repo.PostShowRegistration)
